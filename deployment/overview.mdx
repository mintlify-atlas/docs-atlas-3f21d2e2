...
<Note>
  Additional deployment options like Azure Container Apps and Kubernetes can be configured using the containerization patterns described in the [Docker deployment guide](/deployment/docker).
</Note>
